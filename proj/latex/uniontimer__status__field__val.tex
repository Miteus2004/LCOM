\doxysection{Referência à união timer\+\_\+status\+\_\+field\+\_\+val}
\hypertarget{uniontimer__status__field__val}{}\label{uniontimer__status__field__val}\index{timer\_status\_field\_val@{timer\_status\_field\_val}}
...
\item 
src/\+Controlers/\+Timers/\mbox{\hyperlink{timer_8h}{timer.\+h}}\end{DoxyCompactItemize}
